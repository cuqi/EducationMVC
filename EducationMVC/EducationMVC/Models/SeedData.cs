        ...
        public static void Initialize(IServiceProvider serviceProvider)
        {
            using (var context = new EducationMVCContext(serviceProvider.GetRequiredService<DbContextOptions<EducationMVCContext>>()))
            {
                ...
                context.Student.AddRange(
                    new Student { /*Id = 1,*/ StudentId = "101", FirstName = "Vladimir",    LastName = "Krstikj",   EnrollmentDate = DateTime.Parse("2017-2-1"), AcquiredCredits = 200, CurrentSemester = 6, EducationLevel = "Diploma" },
                    new Student { /*Id = 2,*/ StudentId = "102", FirstName = "Stojan",      LastName = "Nebiten",   EnrollmentDate = DateTime.Parse("2017-2-2"), AcquiredCredits = 105, CurrentSemester = 4, EducationLevel = "Diploma" },
                    new Student { /*Id = 3,*/ StudentId = "103", FirstName = "Blabla",      LastName = "Yeye",      EnrollmentDate = DateTime.Parse("2017-2-3"), AcquiredCredits = 140, CurrentSemester = 2, EducationLevel = "Diploma" },
                    new Student { /*Id = 1,*/ StudentId = "104", FirstName = "Marko",       LastName = "Chovekot",  EnrollmentDate = DateTime.Parse("2017-2-4"), AcquiredCredits = 50,  CurrentSemester = 2, EducationLevel = "Diploma" },
                    new Student { /*Id = 1,*/ StudentId = "105", FirstName = "Student5",    LastName = "Okey",      EnrollmentDate = DateTime.Parse("2017-2-5"), AcquiredCredits = 75,  CurrentSemester = 4, EducationLevel = "Diploma" }
                    );
                context.SaveChanges();
